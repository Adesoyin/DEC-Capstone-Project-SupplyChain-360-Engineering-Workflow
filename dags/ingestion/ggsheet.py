...
def ingest_google_sheet_to_s3():
    # Fetch variables inside the function or as arguments
    ...
    # Validate they exist before proceeding
    if not all(
        [
            spreadsheet_id,
            worksheet_name,
    ...
    try:
        ...
        logger.info(
            f"Loaded Google Sheet → s3://{destination_bucket}/{destination_key}"
        )
...
if __name__ == "__main__":
    ...
    # Just call the function; it handles its own env loading now
