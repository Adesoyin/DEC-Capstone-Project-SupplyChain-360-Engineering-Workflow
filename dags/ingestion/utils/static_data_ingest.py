...
def ingest_static_csv_to_parquet(source_bucket, source_key, destination_bucket, destination_key):
    try:
        ...
        print("=" * 20)
        logging.info(f"Success! Moved {source_key} from DEC_bucket to {destination_bucket}")
